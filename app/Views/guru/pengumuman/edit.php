...
<div class="card border-0 shadow-sm rounded-4">
    ...
    <div class="card-body pt-4">
        <form action="<?= base_url('guru/pengumuman/update/' . $pengumuman['id']) ?>" method="post">
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light border-0" name="judul" value="<?= $pengumuman['judul'] ?>" required>
                    </div>
                    ...
                    <div class="card bg-primary bg-opacity-10 border-0 shadow-none rounded-4 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="datetime-local" class="form-control bg-white border-0" name="tgl_publish" required value="<?= date('Y-m-d\TH:i', strtotime($pengumuman['tgl_publish'])) ?>">
                            </div>
                            
                            <button type="submit" class="btn btn-primary w-100 rounded-pill fw-bold py-2 shadow-sm"><i class="bi bi-save me-2"></i> Update Pengumuman</button>
                        </div>
                    </div>
                </div>
            </div>
