    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body pt-4">
                <form action="<?= base_url('guru/galeri_video/update/' . $galeri['id']) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control form-control-lg bg-light border-0" name="link_youtube" value="<?= $galeri['link_youtube'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control bg-light border-0" name="thumbnail" accept="image/png, image/jpeg">
                    ...
                    <div class="text-end border-top pt-4">
                        <button type="submit" class="btn btn-primary px-5 py-2 rounded-pill fw-bold shadow-sm"><i class="bi bi-save me-2"></i> Update Data Video</button>
                    </div>
                </form>
            </div>
        </div>
