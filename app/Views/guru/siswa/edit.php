...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-header bg-white border-bottom pb-3 pt-4 d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0 fw-bold"><i class="bi bi-pencil-square me-2 text-primary"></i> Edit Data Siswa (Wali Kelas)</h5>
        <a href="<?= base_url('guru/siswa') ?>" class="btn btn-outline-secondary rounded-pill btn-sm fw-semibold"><i class="bi bi-arrow-left me-1"></i> Kembali</a>
    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control form-control-lg bg-light border-0" name="alamat" rows="3"><?= $siswa['alamat'] ?></textarea>
                    </div>
                </div>
            </div>
