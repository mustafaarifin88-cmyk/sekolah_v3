...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-header bg-white border-bottom pb-3 pt-4 d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0 fw-bold"><i class="bi bi-pencil-square me-2 text-primary"></i> Edit Struktur Organisasi</h5>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="judul" value="<?= $struktur['judul'] ?>" required>
                    </div>
                    
                    <div class="form-group mb-3">
                        <label class="form-label fw-semibold">Ganti Bagan/Foto (Biarkan kosong jika tidak diganti)</label>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3 text-center border rounded-3 p-3 bg-light">
                        <label class="form-label fw-semibold d-block mb-3">Foto / Bagan Saat Ini</label>
                        <img src="<?= base_url('uploads/struktur/' . $struktur['foto']) ?>" class="img-fluid rounded-3 shadow-sm" style="max-height: 150px; object-fit: contain;">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group mb-4">
                        <label class="form-label fw-semibold">Keterangan (Opsional)</label>
                        <textarea class="form-control summernote" name="keterangan"><?= $struktur['keterangan'] ?></textarea>
                    </div>
                </div>
            </div>
