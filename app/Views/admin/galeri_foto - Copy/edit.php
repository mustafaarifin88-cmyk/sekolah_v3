    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body pt-4">
                <form action="<?= base_url('admin/galeri_foto/update/' . $galeri['id']) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-end border-top pt-4">
                        <button type="submit" class="btn btn-primary px-5 py-2 rounded-pill fw-bold"><i class="bi bi-save me-2"></i> Update Data Foto</button>
                    </div>
                </form>
            </div>
        </div>
