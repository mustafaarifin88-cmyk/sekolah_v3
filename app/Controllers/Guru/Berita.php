...
class Berita extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/berita/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('guru/berita/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/berita')->with('success', 'Berita berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('guru/berita/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/berita')->with('success', 'Berita berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/guru/berita')->with('success', 'Berita berhasil dihapus.');
    }
}