...
class GaleriVideo extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/galeri_video/index', $data);
    }

    public function create()
    {
        $data = ['title' => 'Tambah Video'];
        return view('guru/galeri_video/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/galeri_video')->with('success', 'Video berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('guru/galeri_video/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/galeri_video')->with('success', 'Video berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/guru/galeri_video')->with('success', 'Video berhasil dihapus.');
    }
}