...
class GaleriFoto extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/galeri_foto/index', $data);
    }

    public function create()
    {
        $data = ['title' => 'Tambah Foto'];
        return view('admin/galeri_foto/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/admin/galeri_foto')->with('success', 'Foto berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/galeri_foto/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/admin/galeri_foto')->with('success', 'Foto berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/admin/galeri_foto')->with('success', 'Foto berhasil dihapus.');
    }
}